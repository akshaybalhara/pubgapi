...
public class JwtRequestFilter extends OncePerRequestFilter {
	...
	/**
	 * doFilterInternal is the callback method invoked by Filter method which is 
	 * responsible for :
	 *  i)  Validating whether current request needs to be authenticated or not.
	 *  ii) Checking the authenticity of the Bearer Token if one is present in the Header.   
	 */
	@Override
